...
| Латентность / стоимость | ✅ 1 LLM-вызов | ⚠️ 3–6 LLM-вызовов (частично мелких) | ❌ Непредсказуемо много |
...
- (−) До ~6 LLM-вызовов в худшем случае на локальной модели — p95 честно отражён в NFR; смягчение: grading-вызовы короткие, кэш retrieval, эвристики до LLM-judge.

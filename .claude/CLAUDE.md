...
RAG-платформа корпоративных знаний: гибридный поиск (BM25+вектор+RRF+rerank), LangGraph-граф с проверкой достаточности контекста и обязательными цитатами. MVP — портфолио-кейс с явным путём до production.

...
Фазы **0–7 — MVP-трек** (результат показывается на собеседовании), **P1–P4 — production-трек**. Трудозатраты — оценка для одного разработчика с Claude Code (календарные дни неполной занятости).
